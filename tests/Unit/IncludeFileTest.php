...
final class IncludeFileTest extends BaseTestCase
{
    ...
    {
        unlink($this->testDir . $this->subject::INCLUDE_FILE);
        rmdir(dirname($this->testDir . $this->subject::INCLUDE_FILE));
    }
    ...
    public function testIncludeFileCanPeWritten()
    {
        ...
        self::assertTrue(file_exists($this->testDir . $this->subject::INCLUDE_FILE));
    }
}
